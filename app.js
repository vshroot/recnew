...
(() => {
  ...
  const progressTextEl = $("#progressText") || (progressSectionEl ? progressSectionEl.querySelector("#progressText") : null);
...
function setProgress(text, pct) {
    // Make progress visible and update only the text node, not the whole section.
